...
@section('content')
    <div class="attendance_group">
        @if (request()->is('admin/stamp_correction_request/list'))
            <div class="attendance_title">
                <h2>申請一覧</h2>
            </div>
            <div class="attendance_status">
                <a href="/admin/stamp_correction_request/list" class="active_tab">承認待ち</a>
                <a href="/admin/stamp_correction_request/list/approval">承認済み</a>
            </div>
                ...
                <table>
                    ...
                    @foreach($waitingApprovals as $waitingApproval)
                        <tr>
                            ...
                            <td>
                                <a href="/admin/stamp_correction_request/approve/{{ $waitingApproval->attendanceApplication->attendance_id }}">詳細</a>
                            </td>
                        </tr>
                    @endforeach
                </table>
            </div>
        @elseif(request()->is('admin/stamp_correction_request/list/approval'))
            <div class="attendance_title">
                <h2>申請一覧</h2>
            </div>
            <div class="attendance_status">
                <a href="/admin/stamp_correction_request/list">承認待ち</a>
                <a href="/admin/stamp_correction_request/list/approval" class="active_tab">承認済み</a>
            </div>
                ...
                <table>
                    ...
                    @foreach($approvals as $approval)
                        <tr>
                            ...
                            <td>
                                <a href="/admin/stamp_correction_request/approve/{{ $approval->attendanceApplication->attendance_id }}">詳細</a>
                            </td>
                        </tr>
                    @endforeach
                </table>
